...
<img
  src={buttonTypes}
  alt="#PraCegoVer Os cinco tipos de botões dispostos lado a lado, sendo 1 o Primary, 2 o Secondary, 3 o Tertiary, 4 o Primary Button e 5 o Secondary Danger"
/>
...
<img
  src={buttonAnatomy}
  alt="#PraCegoVer Anatomia dos cinco tipos de botões disposto lado a lado, sendo 1 a label, 2 o background e 3 o border"
/>
...
<img
  src={buttonToken}
  alt="#PraCegoVer Descrição dos tokens customizados que foram utilizados na construção do botão."
/>
...
<img
  src={buttonSize}
  alt="#PraCegoVer Três variações de tamanho para o botão dispostas lado a lado, sendo 1 o tamanho small, 2 o tamanho medium e 3 o tamanho large"
/>
...
<img
  src={buttonWidth}
  alt="#PraCegoVer Dois botões demonstrando como a largura do botão aumenta conforme o a label que é inserida"
/>
