(window.webpackJsonp = window.webpackJsonp || []).push([
  [5],
  {
    1046: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var index_module_s,
        ...
        index_module_d = function (e, r) {
          ...
          return {
            left: index_module_f(
              (o.pageX - (t.left + window.pageXOffset)) / t.width
            ),
            top: index_module_f(
              (o.pageY - (t.top + window.pageYOffset)) / t.height
            ),
          };
        },
        index_module_h = react_default.a.memo(function (r) {
          var t = r.onMove,
            ...
            E = Object(react.useCallback)(
              function (e) {
                e.preventDefault(),
                  (index_module_v(e) ? e.touches.length > 0 : e.buttons > 0) &&
                  h.current
            ...
            x = Object(react.useCallback)(
              function (e) {
                ...
                r.preventDefault(),
                  (function (e) {
                    return !(
                      (m.current && !index_module_v(e)) ||
                      (m.current || (m.current = index_module_v(e)), 0)
                    );
        ...
        index_module_ = function (e) {
          var r = /hsla?\((\d+\.?\d*),\s*(\d+\.?\d*)%?,\s*(\d+\.?\d*)%?,?\s*(\d+\.?\d*)?\)/.exec(
            e
          );
          return r
            ? index_module_E({
        ...
        B = react_default.a.memo(function (r) {
          var t = r.hsva,
            o = r.onChange,
            n = {
              backgroundColor: index_module_H({ h: t.h, s: 100, v: 100, a: 1 }),
            };
          return react_default.a.createElement(
            'div',
            ...
            react_default.a.createElement(
              index_module_h,
              {
                ...
                onKey: function (e) {
                  o({
                    s: index_module_f(t.s + 100 * e.left, 0, 100),
                    v: index_module_f(t.v - 100 * e.top, 0, 100),
                  });
                },
                'aria-label': 'Color',
                'aria-valuetext':
      ...
      var L,
        ...
        X = function (r) {
          ...
          return react_default.a.createElement(
            ...
            react_default.a.createElement(z, {
              hue: f.h,
              onChange: v,
        ...
        Y = {
          ...
          equal: function (e, r) {
            return (
              ...
              K(index_module_b(e), index_module_b(r))
            );
          },
        },
        P = function (r) {
        ...
        Q = {
          ...
          toHsva: index_module_,
          fromHsva: index_module_N,
          equal: A,
        },
        fe = {
        ...
        color_convert = __webpack_require__(1117),
        color_convert_default = __webpack_require__.n(color_convert),
        throttle = __webpack_require__(1120),
        throttle_default = __webpack_require__.n(throttle),
        esm = __webpack_require__(2),
        TooltipNote = __webpack_require__(559),
        lazy_WithTooltip = __webpack_require__(171),
        esm_form = __webpack_require__(66),
    ...
    1061: function (module, exports, __webpack_require__) {
      const cssKeywords = __webpack_require__(1118),
        reverseKeywords = {};
    ...
    1117: function (module, exports, __webpack_require__) {
      const conversions = __webpack_require__(1061),
        route = __webpack_require__(1119),
        convert = {};
    ...
    1120: function (module, exports, __webpack_require__) {
      var debounce = __webpack_require__(1121),
    ...
    1121: function (module, exports, __webpack_require__) {
      var isObject = __webpack_require__(114),
        now = __webpack_require__(1122),
        toNumber = __webpack_require__(1123),
        nativeMax = Math.max,
        nativeMin = Math.min;
    ...
    1123: function (module, exports, __webpack_require__) {
      var baseTrim = __webpack_require__(1124),
        isObject = __webpack_require__(114),
    ...
    1124: function (module, exports, __webpack_require__) {
      var trimmedEndIndex = __webpack_require__(1125),
        reTrimStart = /^\s+/;
    ...
    559: function (module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__(12), __webpack_require__(9), __webpack_require__(116);
