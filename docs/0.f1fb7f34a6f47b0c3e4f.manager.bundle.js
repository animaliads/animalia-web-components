  ...
  [0],
  {
    516: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var react = __webpack_require__(0),
        ...
        objectWithoutPropertiesLoose = __webpack_require__(50),
        esm_extends = __webpack_require__(6),
        inheritsLoose = __webpack_require__(155),
        react_dom = __webpack_require__(181),
        ...
        return (
          (isOffsetParentAnElement || (!isOffsetParentAnElement && !isFixed)) &&
            ...
            isHTMLElement(offsetParent)
              ? (((offsets = getBoundingClientRect(offsetParent)).x +=
      ...
      var popper_createPopper = popperGenerator({
              ...
              fn: function flip(_ref) {
                ...
                if (!state.modifiersData[name]._skip) {
                  for (
                        ...
                        (basePlacement === preferredPlacement || !flipVariations
                          ...
                          : (function getExpandedFallbackPlacements(placement) {
                              if ('auto' === getBasePlacement(placement))
                                return [];
                              var oppositePlacement = getOppositePlacement(
                                placement
                              );
                              return [
                    ...
                    var altVariationSide = getOppositePlacement(
                        mainVariationSide
                      ),
                      checks = [];
                    if (
              ...
              effect: function arrow_effect(_ref2) {
                ...
                null != arrowElement &&
                  ('string' != typeof arrowElement ||
                    (arrowElement = state.elements.popper.querySelector(
                      arrowElement
                    ))) &&
        ...
        react_fast_compare = __webpack_require__(440),
      ...
      var warning = __webpack_require__(515),
        ...
        return (
          Object(react.useEffect)(function () {
            ...
            var iframes = Array.from(
                global_window.document.getElementsByTagName('iframe')
              ),
              unbinders = [];
            return (
