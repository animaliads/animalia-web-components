/*! For license information please see 6.d0145d35.iframe.bundle.js.LICENSE.txt */
  ...
  [6],
  {
    1044: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var react__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1),
        ...
        overlayscrollbars__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          1126
        ),
        ...
        return (
          react__WEBPACK_IMPORTED_MODULE_11___default.a.useEffect(function () {
            return (
              ...
              function () {
                overlayscrollbars__WEBPACK_IMPORTED_MODULE_12___default.a.valid(
                  osInstance.current
                ) &&
              ...
              var _targets,
                ...
                FRAMEWORK = (function () {
                  ...
                  function setAnimationValue(el, prop, value) {
                    'scrollLeft' === prop || 'scrollTop' === prop
                      ? (el[prop] = value)
                ...
                PLUGIN = (function () {
                          ...
                          FRAMEWORK(window).on('resize', function () {
                            if (INSTANCES().length > 0) {
                              ...
                              var newScrollbarSize,
                                ...
                                difference = !(function differenceIsBiggerThanOne(
                                  valOne,
                                  valTwo
                                ) {
                  ...
                  function OverlayScrollbarsInstance(
                    ...
                    if (isHTMLElement(pluginTargetElement)) {
                      ...
                      var _nativeScrollbarIsOverlaid,
                        ...
                        _classNameHostScrollbarVerticalHidden =
                          _classNameHostElement + '-scrollbar-vertical-hidden',
                      ...
                      return (
                        ...
                        (_base.scroll = function (
                          ...
                          function getRawScroll(isX, coordinates) {
                            ...
                            if (
                              ((coordinates =
                                type(coordinates) == TYPES_s ||
                                type(coordinates) == TYPES_n
                                ...
                                (currValueType = type(currValue)) == TYPES_b
                                  ? result.push(
                                      currValue
                                        ? parseToZeroOrNumber(
                                            finalElement.css(
                                              'margin-' + valueDirections[i]
                                            )
                                          )
                                        : 0
                                    )
                                  : result.push(
                                      currValueType == TYPES_n ? currValue : 0
                                    );
                            return result;
                          }
                          if (
                            ...
                            if (
                              ...
                              if (
                                ...
                                var measuringElm = finalElement[0],
                                  ...
                                  elementSize = {
                                    w:
                                      rawElementSize.width +
                                      settingsMargin[3] +
                                      settingsMargin[1],
                                    h:
                                      rawElementSize.height +
                                      settingsMargin[0] +
                                      settingsMargin[2],
                                  },
                          ...
                          (finalScroll.scrollLeft = getFinalScroll(
                            !0,
                            getRawScroll(!0, coordinates)
                          )),
                            (finalScroll.scrollTop = getFinalScroll(
                              !1,
                              getRawScroll(!1, coordinates)
                            )),
                            (doScrollLeft =
                              finalScroll.scrollLeft !== undefined),
                            ...
                            (duration > 0 || durationIsObject)
                              ? durationIsObject
                                ...
                                : ((animationOptions = {
                                  ...
                                  FRAMEWORK.isPlainObject(easing)
                                    ? ((specialEasing.scrollLeft =
                                        easing[0] || easing.x),
                                      (specialEasing.scrollTop =
                                        easing[1] || easing.y),
                              ...
                              : (doScrollLeft &&
                                  _viewportElement.scrollLeft(
                                    finalScroll.scrollLeft
                                  ),
                                doScrollTop &&
                        ...
                        _plugin.valid(
                          (function construct(
                            ...
                            return (
                              ...
                              setOptions(
                                extendDeep({}, _defaultOptions, options)
                              ),
                              ...
                              (_domExists = _isTextarea
                                ...
                                : _targetElement.hasClass(
                                  ...
                                  _targetElement.children('.os-padding')[
                                    LEXICON.l
                                  ]),
                              ...
                              !_currentPreparedOptions.nativeScrollbarsOverlaid
                                ...
                                : (_isBody &&
                                      ...
                                      function (event) {
                                        onMouseTouchDownContinue(event) &&
                                          ...
                                          (_mutationObserversConnected &&
                                            ...
                                            disconnectMutationObservers()),
                                          (mouseDownPosition = getCoordinates(
                                            event
                                          )),
                                          (mouseDownSize.w =
                                  ...
                                  _isBody &&
                                    (_viewportElement
                                      .scrollLeft(initBodyScroll.l)
                                      .scrollTop(initBodyScroll.t),
                        ...
                        if (onElementResizedCallback) {
                          if (_supportResizeObserver)
                            ((element = targetElement
                              ...
                              .contents()[0]).__overlayScrollbarsRO__ = new resizeObserver(
                              callback
                            )).observe(element);
                          else if (
                            _msieVersion > 9 ||
                              ...
                              generateDiv(
                                ...
                                generateDiv(
                                  ...
                                  generateDiv(
                                    ...
                                    generateDiv('os-resize-observer-item-final')
                                  ) +
                                    generateDiv(
                                      'os-resize-observer-item',
                                      generateDiv({
                            ...
                            var isDirty,
                              ...
                              currHeight,
                              observerElement =
                                targetElement[0].childNodes[0].childNodes[0],
                            ...
                            if (attachEvent)
                              targetElement.prepend(
                                generateDiv('os-resize-observer')
                              ),
                                findFirst(
                                  targetElement,
                                  '.os-resize-observer'
                          ...
                          resizeObserverObj &&
                            ...
                            delete element.__overlayScrollbarsRO__);
                        } else
                          remove(
                            targetElement.children('.os-resize-observer').eq(0)
                          );
                      }
                    }
                          ...
                          return (
                            _initialized &&
                              ...
                              (each(mutations, function () {
                                return !(doUpdate = (function isUnknownMutation(
                                  mutation
                                ) {
                                  ...
                                  if (
                                    ...
                                    if (
                                      typeof mutationTarget.closest != TYPES_f
                                    )
                                      return !0;
                                    if (
                                      null !==
                            ...
                            (_mutationObserverHostCallback = function (
                              ...
                              return (
                                _initialized &&
                                  ...
                                  doUpdate &&
                                    _base.update(doUpdateForce || 'auto')),
                                doUpdate
                              );
                            })
                          )),
                      ...
                      return (
                        _isBody &&
                          ...
                          ((bodyMinSize.w = parseToZeroOrNumber(
                            _contentArrangeElement.css('min-width')
                          )),
                          (bodyMinSize.h = parseToZeroOrNumber(
                            _contentArrangeElement.css('min-height')
                          )),
                    ...
                    function update(updateHints) {
                      ...
                      if (
                        (swallow &&
                          (_swallowedUpdateTimeout = setTimeout(update, 42)),
                        !(
                          _destroyed ||
                          swallow ||
                        ...
                        if (
                          ...
                          classNameChanged &&
                            (removeClass(
                              _hostElement,
                              _oldClassName + ' ' + _classNameThemeNone
                            ),
                            addClass(
                              _hostElement,
                              className !== undefined &&
                          ...
                          if (sizeAutoCapable)
                            if (
                              ...
                              (_sizeAutoObserverElement = FRAMEWORK(
                                generateDiv('os-size-auto-observer')
                              )),
                                (_sizeAutoObserverElementNative =
                        ...
                        if (
                          ...
                          (widthAutoChanged ||
                            ...
                            border.c ||
                            cssDirectionChanged)
                            ? ((contentElementCSS.width = 'auto'),
                              (contentGlueElementCSS['max-width'] = '100%'))
                          ...
                          _nativeScrollbarStyling ||
                            ((viewportElementResetCSS.bottom = wasHeightAuto
                              ? ''
                              : resetBottomTmp),
                          ...
                          var hideOverflowForceTextarea =
                            ...
                            setOverflowVariables = function (horizontal) {
                              var scrollbarVars = getScrollbarVars(horizontal),
                                ...
                                scrollMax =
                                  'scroll' + scrollbarVars._Left_Top + 'Max',
                          ...
                          if (
                            ...
                            (hasOverflow.x || hasOverflow.y) &&
                              ...
                              (hasOverflow.c ||
                                ...
                                ((contentElementCSS[
                                  'margin-' + isRTLRight
                                ] = contentElementCSS['border-' + isRTLRight] =
                                  ''),
                              ...
                              arrangeChanged &&
                                !_nativeScrollbarStyling &&
                                ((contentArrangeElementCSS.width = hideOverflow.y
                                  ? arrangeContent.w
                                  : ''),
                                (contentArrangeElementCSS.height = hideOverflow.x
                                  ? arrangeContent.h
                                  : ''),
                                _contentArrangeElement ||
                                  ((_contentArrangeElement = FRAMEWORK(
                                    generateDiv('os-content-arrange')
                                  )),
                          ...
                          if (
                            ...
                            (hostSizeChanged ||
                              ...
                              (viewportElementCSS[
                                'padding-' + isRTLLeft
                              ] = viewportElementCSS['margin-' + isRTLLeft] =
                                ''),
                            ...
                            var textareaInfo = (function getTextareaInfo() {
                              ...
                              if (textareaCursorPosition !== undefined) {
                                var rowCols,
                                  ...
                                  textareaLastCol = 0,
                                  cursorRow =
                                    textareaCurrentCursorRowSplit[LEXICON.l],
                                  cursorCol =
                          ...
                          _isRTL &&
                            ...
                            _viewportElement
                              .scrollLeft(currScroll.x)
                              .scrollTop(currScroll.y);
                          ...
                          _contentElement
                            ...
                            .each(function (i, el) {
                              COMPATIBILITY.inA(el, _updateOnLoadElms) < 0 &&
                                ...
                                FRAMEWORK(el)
                                  .off('load', updateOnLoadCallback)
                                  .on('load', updateOnLoadCallback));
                            });
                        });
                    }
                      ...
                      (_hostElement =
                        ...
                        (_contentElement =
                          ...
                          selectOrGenerateDivByClass(
                            'os-content' + textareaClass
                          )),
                        (_viewportElement =
                          _viewportElement ||
                          selectOrGenerateDivByClass(
                            'os-viewport' + textareaClass
                          )),
                        (_paddingElement =
                          _paddingElement ||
                          selectOrGenerateDivByClass(
                            'os-padding' + textareaClass
                          )),
                        (_sizeObserverElement =
                          _sizeObserverElement ||
                          selectOrGenerateDivByClass(
                        ...
                        destroy
                          ...
                          : (_isTextarea &&
                              (_currentPreparedOptions.sizeAutoCapable ||
                                ((hostElementCSS.width = _targetElement.css(
                                  'width'
                                )),
                                (hostElementCSS.height = _targetElement.css(
                                  'height'
                                ))),
                              _domExists ||
                                _targetElement
                            ...
                            function onTrackMouseTouchDown(event) {
                              if (onMouseTouchDownContinue(event)) {
                                ...
                                ctrlKey && increaseTrackScrollAmount(),
                                  ...
                                  (mouseDownOffset = COMPATIBILITY.page(event)[
                                    xy
                                  ]),
                                  (_scrollbarsHandlesDefineScrollPos = !getPreparedScrollbarsOption(
                                    'snapHandle'
                    ...
                    function refreshScrollbarHandleOffset(
                      ...
                      var transformOffset,
                        ...
                        maxScroll =
                          (_viewportElementNative[
                            'scroll' + scrollbarVars._Width_Height
                          ] -
                            _viewportElementNative[
                              ...
                              (handleCSS[strTransition] =
                                ...
                                MATH.abs(
                                  ...
                                  ? (function getCSSTransitionString(element) {
                                      var transitionStr = VENDORS._cssProperty(
                                          'transition'
                                        ),
                                        assembledValue = element.css(
                                          transitionStr
                                        );
                    ...
                    function setupScrollbarCornerDOM(destroy) {
                      (_scrollbarCornerElement =
                        _scrollbarCornerElement ||
                        selectOrGenerateDivByClass('os-scrollbar-corner', !0)),
                        destroy
                          ? _domExists && _initialized
                            ? removeClass(
                    ...
                    function setTopRightBottomLeft(
                      ...
                      (values = values || ['', '', '', '']),
                        (targetCSSObject[(prefix = prefix || '') + 'top'] =
                          values[0]),
                      ...
                      return (
                        ...
                        (prefix = prefix || ''),
                        {
                          t: zeroY
                            ? 0
                            : parseToZeroOrNumber(
                                _hostElement.css(prefix + 'top' + suffix)
                              ),
                          r: zeroX
                            ? 0
                            : parseToZeroOrNumber(
                                _hostElement.css(prefix + 'right' + suffix)
                              ),
                          b: zeroY
                            ? 0
                            : parseToZeroOrNumber(
                                _hostElement.css(prefix + 'bottom' + suffix)
                              ),
                          l: zeroX
                            ? 0
                            : parseToZeroOrNumber(
                                _hostElement.css(prefix + 'left' + suffix)
                              ),
                        }
                      );
                    }
                    ...
                    function checkCache(current, cache, force) {
                      ...
                      if (type(current) != TYPES_o || type(cache) != TYPES_o)
                  ...
                  return (
                    ((_plugin = window.OverlayScrollbars = function (
...
//# sourceMappingURL=6.d0145d35.iframe.bundle.js.map
